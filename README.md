...
To build the final jar and optimize the AbsaDTGatewayMsv application for production, run:
...
Then navigate to [http://localhost:9022](http://localhost:9022) in your browser.
